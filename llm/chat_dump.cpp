...
void Qwen::init(const std::vector<int> &devices, std::string model_path) {
  ...
  for (int i = 0; i < NUM_LAYERS; i++) {
    ...
    if (io_alone_reuse) {
      ...
      d2d(tmp_key_cache, prev_past_key[i], 0, share_length * bytes);
      d2d(tmp_value_cache, prev_past_value[i], 0, share_length * bytes);
      empty(past_key[i]);
      empty(past_value[i]);
      d2d(past_key[i], tmp_key_cache, 0, share_length * bytes);
      d2d(past_value[i], tmp_value_cache, 0, share_length * bytes);
    }
  }
}
...
void Qwen::empty_kvcache() {
  for (int i = 0; i < NUM_LAYERS; i++) {
    empty(past_key[i]);
    empty(past_value[i]);
    empty(net_blocks_unshare[i]->stages[0].input_mems[3]);
    empty(net_blocks_unshare[i]->stages[0].input_mems[4]);
  }
  return;
}
...
// #ifdef DUMP_TENSOR
//     if (io_alone_reuse == false) {
//       dump_tensor_to_file<uint16_t>(bm_handle,net_blocks_unshare[idx]->stages[0].input_mems[0],{1,1536,4096},"input_8704_" + std::to_string(idx) + ".npz","input_states");
//       dump_tensor_to_file<int32_t>(bm_handle,net_blocks_unshare[idx]->stages[0].input_mems[1],{1,1536},"input_8704_" + std::to_string(idx) + ".npz","position_ids");
//       dump_tensor_to_file<uint16_t>(bm_handle,net_blocks_unshare[idx]->stages[0].input_mems[2],{1,1,1536,7424},"input_8704_" + std::to_string(idx) + ".npz","attention_mask");
//       dump_tensor_to_file<uint16_t>(bm_handle,net_blocks_unshare[idx]->stages[0].input_mems[3],{1,5888,32,128},"input_8704_" + std::to_string(idx) + ".npz","history_k");
//       dump_tensor_to_file<uint16_t>(bm_handle,net_blocks_unshare[idx]->stages[0].input_mems[4],{1,5888,32,128},"input_8704_" + std::to_string(idx) + ".npz","history_v");

//       dump_tensor_to_file<uint16_t>(bm_handle,net_blocks_unshare[idx]->stages[0].output_mems[0],{1,1536,4096},"output_" + std::to_string(idx) + ".npz","hidden_states");
//       dump_tensor_to_file<uint16_t>(bm_handle,net_blocks_unshare[idx]->stages[0].output_mems[1],{1,1536,32,128},"output_" + std::to_string(idx) + ".npz","present_key");
//       dump_tensor_to_file<uint16_t>(bm_handle,net_blocks_unshare[idx]->stages[0].output_mems[2],{1,1536,32,128},"output_" + std::to_string(idx) + ".npz","present_value");
//     } else if (io_alone_reuse == true) {
//       dump_tensor_to_file<uint16_t>(bm_handle,net_blocks_unshare[idx]->stages[0].input_mems[0],{1,1024,4096},"input_7552_" + std::to_string(idx) + ".npz","input_states");
//       dump_tensor_to_file<int32_t>(bm_handle,net_blocks_unshare[idx]->stages[0].input_mems[1],{1,1024},"input_7552_" + std::to_string(idx) + ".npz","position_ids");
//       dump_tensor_to_file<uint16_t>(bm_handle,net_blocks_unshare[idx]->stages[0].input_mems[2],{1,1,1024,7040},"input_7552_" + std::to_string(idx) + ".npz","attention_mask");
//       dump_tensor_to_file<uint16_t>(bm_handle,net_blocks_unshare[idx]->stages[0].input_mems[3],{1,6016,32,128},"input_7552_" + std::to_string(idx) + ".npz","history_k");
//       dump_tensor_to_file<uint16_t>(bm_handle,net_blocks_unshare[idx]->stages[0].input_mems[4],{1,6016,32,128},"input_7552_" + std::to_string(idx) + ".npz","history_v");

//       dump_tensor_to_file<uint16_t>(bm_handle,net_blocks_unshare[idx]->stages[0].output_mems[0],{1,1024,4096},"output_7552_" + std::to_string(idx) + ".npz","hidden_states");
//       dump_tensor_to_file<uint16_t>(bm_handle,net_blocks_unshare[idx]->stages[0].output_mems[1],{1,1024,32,128},"output_7552_" + std::to_string(idx) + ".npz","present_key");
//       dump_tensor_to_file<uint16_t>(bm_handle,net_blocks_unshare[idx]->stages[0].output_mems[2],{1,1024,32,128},"output_7552_" + std::to_string(idx) + ".npz","present_value");
//     }
// #endif
  }
...
int Qwen::forward_next() {
  ...
  for (int idx = 0; idx < NUM_LAYERS; idx++) {
    // if ((unshare_length == 49 || unshare_length == 50) && (idx < 1 || idx > 29)) {
    //   std::cout << "-----------------------Unshare Length: " << unshare_length << "-----------------------" << std::endl;
    //   std::cout << "-----------------------Layer: " << idx << "-----------------------" << std::endl;
    //   dump_bf16_tensor(bm_handle, out_mem, 0, 10);
    // }
...
#ifdef DUMP_TENSOR
    if (io_alone_reuse == false && unshare_length == 15) {
      dump_tensor_to_file<uint16_t>(bm_handle,net_blocks_cache[idx]->stages[0].input_mems[0],{1,1,4096},"input_8704_" + std::to_string(unshare_length) + "_" + std::to_string(idx) + ".npz","input_states");
      dump_tensor_to_file<int32_t>(bm_handle,net_blocks_cache[idx]->stages[0].input_mems[1],{1,1},"input_8704_" + std::to_string(unshare_length) + "_" + std::to_string(idx) + ".npz","position_ids");
      dump_tensor_to_file<uint16_t>(bm_handle,net_blocks_cache[idx]->stages[0].input_mems[2],{1,1,1,8705},"input_8704_" + std::to_string(unshare_length) + "_" + std::to_string(idx) + ".npz","attention_mask");
      dump_tensor_to_file<uint16_t>(bm_handle,net_blocks_cache[idx]->stages[0].input_mems[3],{1,8704,32,128},"input_8704_" + std::to_string(unshare_length) + "_" + std::to_string(idx) + ".npz","history_k");
      dump_tensor_to_file<uint16_t>(bm_handle,net_blocks_cache[idx]->stages[0].input_mems[4],{1,8704,32,128},"input_8704_" + std::to_string(unshare_length) + "_" + std::to_string(idx) + ".npz","history_v");

      dump_tensor_to_file<uint16_t>(bm_handle,net_blocks_cache[idx]->stages[0].output_mems[0],{1,1,4096},"output_" + std::to_string(unshare_length) + "_" + std::to_string(idx) + ".npz","hidden_states");
      dump_tensor_to_file<uint16_t>(bm_handle,net_blocks_cache[idx]->stages[0].output_mems[1],{1,1,32,128},"output_" + std::to_string(unshare_length) + "_" + std::to_string(idx) + ".npz","present_key");
      dump_tensor_to_file<uint16_t>(bm_handle,net_blocks_cache[idx]->stages[0].output_mems[2],{1,1,32,128},"output_" + std::to_string(unshare_length) + "_" + std::to_string(idx) + ".npz","present_value");
    } else if (io_alone_reuse == true && unshare_length == 15) {
      dump_tensor_to_file<uint16_t>(bm_handle,net_blocks_cache[idx]->stages[0].input_mems[0],{1,1,4096},"input_7552_" + std::to_string(unshare_length) + "_" + std::to_string(idx) + ".npz","input_states");
      dump_tensor_to_file<int32_t>(bm_handle,net_blocks_cache[idx]->stages[0].input_mems[1],{1,1},"input_7552_" + std::to_string(unshare_length) + "_" + std::to_string(idx) + ".npz","position_ids");
      dump_tensor_to_file<uint16_t>(bm_handle,net_blocks_cache[idx]->stages[0].input_mems[2],{1,1,1,7553},"input_7552_" + std::to_string(unshare_length) + "_" + std::to_string(idx) + ".npz","attention_mask");
      dump_tensor_to_file<uint16_t>(bm_handle,net_blocks_cache[idx]->stages[0].input_mems[3],{1,7552,32,128},"input_7552_" + std::to_string(unshare_length) + "_" + std::to_string(idx) + ".npz","history_k");
      dump_tensor_to_file<uint16_t>(bm_handle,net_blocks_cache[idx]->stages[0].input_mems[4],{1,7552,32,128},"input_7552_" + std::to_string(unshare_length) + "_" + std::to_string(idx) + ".npz","history_v");

      dump_tensor_to_file<uint16_t>(bm_handle,net_blocks_cache[idx]->stages[0].output_mems[0],{1,1,4096},"output_7552_" + std::to_string(unshare_length) + "_" + std::to_string(idx) + ".npz","hidden_states");
      dump_tensor_to_file<uint16_t>(bm_handle,net_blocks_cache[idx]->stages[0].output_mems[1],{1,1,32,128},"output_7552_" + std::to_string(unshare_length) + "_" + std::to_string(idx) + ".npz","present_key");
      dump_tensor_to_file<uint16_t>(bm_handle,net_blocks_cache[idx]->stages[0].output_mems[2],{1,1,32,128},"output_7552_" + std::to_string(unshare_length) + "_" + std::to_string(idx) + ".npz","present_value");
    }
#endif
  }
  ...
  // if ((unshare_length == 49 || unshare_length == 50)) {
